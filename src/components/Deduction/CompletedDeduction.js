import { faBarcode, faCalendar, faCog, faObjectGroup, faPaperPlane, faSdCard, faUser } from '@fortawesome/free-solid-svg-icons'
...
const handleSearch=(index)=>{
     const results=index===''?CompleteDeductions:Deduction.searchCompleted(index)
    ...
    <td>
        {Deduction.Department(d.creater)}
    </td>
    <td>
    <ModalDeduction type='view_calculation' fetch={fetch} deduction={d} ftl={false}/>  
    <ModalDeduction type="view_final" deduction={d} fetch={fetch} user={false}/>
    </td>
         </tr>  
       )  
     })
