import { faChartLine, faCheckCircle, faEye, faUser, faUserCheck, faWindowClose } from '@fortawesome/free-solid-svg-icons'
...
const LetterProgress=({l_id:id})=> {
    ...
    const {socket,messages,connections,
         employees,users,letters}=useContext(StoreContext)
  ...
  const color=message.approval_managers(id).find(ap=> ap.status === 'unApproved')?'red':'info'
  return (
                ...
                <div className="col-lg-12">
     {
          ...
          <td>
        {
          ...
          <p className="text-center text-success">
           <FontAwesomeIcon icon={faCheckCircle} className='fa-2x mx-2 text-success'/>
           Approved   
          </p>:
          m.status==='unApproved'?
          ...
          <p className="text-center">
           <FontAwesomeIcon icon={faEye} className='fa-2x mx-2 text-info'/>
           Reviewing   
          </p>:
          m.status==='waiting'?
                ...
                <div className="widget-content-right w-100">
                    <div className="progress-bar-xs progress">
                        <div className={"progress-bar bg-" + color}
                            role="progressbar" aria-valuenow={message.totallProgress(id)}
