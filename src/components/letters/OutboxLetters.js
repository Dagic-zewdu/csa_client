import { faCalendar, faChartLine, faCog } from '@fortawesome/free-solid-svg-icons'
...
const OutboxLetters=()=> {
  ...
  const {employees,users,connections,messages,letters,socket}=useContext(StoreContext)
...
<button className="search-icon">
                       ...
                       </td>
  {
    message.approval_managers(l._id).length?
      ...
      <div className="">
      <Progress color="info" value={message.totallProgress(l._id)}/>
    ...
    {
      message.isModifiable(l._id)?
      <ModalLetter type='delete_letter' l_id={l._id} emitter={emitter} />:
      <p></p>
    }
