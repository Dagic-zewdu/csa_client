...
import { fieldAllowanceReducer, fieldAllowanceState } from './store/Reducers/FieldAllowance'
...
import { allowanceReducer, allowanceState } from './store/Reducers/allowanceReducer'
import ClimateDashboard from './components/system Admin/place/ClimatePlaces/ClimateDashboard'
import { climatePlacesReducer, climatePlaceState } from './store/Reducers/climatePlacesReducer'
...
const App = () => {
  ...
  const [fieldEmployees,dispatchFieldEmplooyees]=useReducer(fieldAllowanceReducer,fieldAllowanceState)
  ...
  return (
    ...
    <StoreContext.Provider
      value={{
        ...
        users,dispatchUsers,
        fieldEmployees,dispatchFieldEmplooyees,
      ...
      <Route path='/signup'><Signup/></Route>
       {/**admin routes */}
        ...
        <Route path='/fieldAllowance'><FieldDashboard/></Route>
        <Route path='/employee'><Employee /></Route>
        <Route path='/company'><Company/></Route>
        <Route path='/places'><PlaceDashbord /></Route>
        <Route path='/department'><DepartmentDashboard /></Route>
        <Route path='/configuration'><Configure/></Route>
        <Route path='/climate_places'><ClimateDashboard/></Route>
        {/**system configuration route */}
        <Route path='/adminSignUp'><AdminSignup/></Route>
        <Route path='/createCompany'><CreateCompany/></Route>
         <Route path='/createConfiguration'><CreateConfigaration/></Route>
         {/**test routes */}
